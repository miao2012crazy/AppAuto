 ...
 */
@Entity
public class ReserveItemBean extends BaseObservable implements BindingAdapterItem {
    ...
    @Generated(hash = 1704697911)
    public ReserveItemBean(long id, String productDesc, String productId, String productImg01,
